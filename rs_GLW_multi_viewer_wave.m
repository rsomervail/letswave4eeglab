% 
% edited version of letswave 7 function 'GLW_multi_viewer_wave' for letswave4eeglab plugin for eeglab
% 
% letswave4eeglab
% Author: Richard Somervail, Istituto Italiano di Tecnologia, 2023
%           www.iannettilab.net
function rs_GLW_multi_viewer_wave(inputfiles)
handles=[];
userdata=[];
datasets_header={};
datasets_data={};
...
%             [p, n, e]=fileparts(fullfile(inputfiles.file_path,inputfiles.file_str{k})); % orig lines
            ...
            userdata.datasets_filename{k} = inputfiles(k).header.name;
